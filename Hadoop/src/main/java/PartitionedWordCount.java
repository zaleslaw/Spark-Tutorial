...
public class PartitionedWordCount extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
         ...
         */
        job.setJarByClass(PartitionedWordCount.class); // fix ClassNotFoundException (Map or Reduce class)
    ...
    public static class MyPartitioner extends Partitioner<Text, IntWritable >
    {
        ...
        public int getPartition(Text key, IntWritable value, int numReduceTasks)
        {
            ...
            else if(keyString.startsWith("i"))
            {
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new PartitionedWordCount(), args);
        System.exit(res);
    }
